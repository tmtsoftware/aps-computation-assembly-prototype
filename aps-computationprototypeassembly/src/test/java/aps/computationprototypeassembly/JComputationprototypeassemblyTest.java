...
public class JComputationprototypeassemblyTest extends TestNGSuite {
    ...
    public static void setup() {
        ...
        testKit.spawnStandalone(com.typesafe.config.ConfigFactory.load("JComputationprototypeassemblyStandalone.conf"));
    }

    @Test
    public void testAssemblyShouldBeLocatableUsingLocationService() throws ExecutionException, InterruptedException {
        Connection.PekkoConnection connection = new Connection.PekkoConnection(new ComponentId(Prefix.apply("APS.computationPrototypeAssembly"), JComponentType.Assembly));
