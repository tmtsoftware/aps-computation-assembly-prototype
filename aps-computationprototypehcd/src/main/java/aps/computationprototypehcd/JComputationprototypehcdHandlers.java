 ...
 */
public class JComputationprototypehcdHandlers extends JComponentHandlers {

    private final JCswContext cswCtx;
    private final ILogger log;

    JComputationprototypehcdHandlers(ActorContext<TopLevelActorMessage> ctx,JCswContext cswCtx) {
        super(ctx, cswCtx);
        this.cswCtx = cswCtx;
    ...
    log.info("Initializing computationPrototypeHcd...");
    }
