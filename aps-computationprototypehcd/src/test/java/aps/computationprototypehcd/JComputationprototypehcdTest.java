package aps.computationprototypehcd;
...
public class JComputationprototypehcdTest extends TestNGSuite {
    ...
    public static void setup() {
        ...
        testKit.spawnStandalone(com.typesafe.config.ConfigFactory.load("JComputationprototypehcdStandalone.conf"));
    }

    @Test
    public void testHcdShouldBeLocatableUsingLocationService() throws ExecutionException, InterruptedException {
        Connection.PekkoConnection connection = new Connection.PekkoConnection(new ComponentId(Prefix.apply("APS.computationPrototypeHcd"), JComponentType.HCD));
